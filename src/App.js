		...
		<main>
			...
			>
				...
				<p className='about-description'>
					A website is a powerful tool in marketing your products and makes a
					good appeal to your business. One of the great ways to make your
					business more reliable and showcase what your company is all about is
					by building a website. Here, I do not just build your website, but I
					also develop your business. I will use your marketing strategic plan
					to create a better platform for you.
					<br />
					&nbsp;
					<br />
					I can make a personalized platform for your website users through
					innovation and knowing your customer personas. A customized platform
					can attract more users, audiences, or customers that can turn into
					leads. In the competitive world of the business industry, website
					appearance and user experience are crucial because they can make or
					break a deal. With my skills, I can help your business grow by
					developing a website personalized for your business.
					<br />
					&nbsp; <br />
					&nbsp;
				</p>
			...
			>
				...
				<div className='skillset'>
					...
					<div className='graphic-design skill'>
						...
						<p className='skillset-description'>
							Create a visual content to relay messages. Typography and images
							are used to display interactive designs to optimize the user
							experience.
						</p>
					</div>
			...
			>
				...
				<p className='projects-description'>
					As your web developer, my goal is to help you market your products and
					services through your website. Its contents and functionality matters
					as it plays a big role in your business. We do not just build your
					website, but it's your business we are building. We will incorporate
					the trends tailor-made for your business needs.
				</p>
